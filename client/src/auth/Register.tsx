  ...
  return (
    <div className="min-h-screen bg-void-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        >
          <h1 className="font-cinzel text-2xl text-center text-ghost-white mb-2">Forge Your Identity</h1>
          <p className="text-center text-amber-400/50 mb-8">Begin the journey</p>
          ...
          {success && (
            ...
            >
              ...
              <span>Identity forged. Entering the Forge...</span>
            </motion.div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-xs font-medium text-amber-400/60 mb-2">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-amber-400/30" />
                <input
                  type={showPassword ? 'text' : 'password'}
          ...
          <p className="mt-6 text-center text-amber-400/40 text-sm">
            ...
            <Link to="/login" className="text-ancient-gold hover:text-amber-400 font-medium transition-colors">
              Enter the Forge
            </Link>
          </p>
        </motion.div>
