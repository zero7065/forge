...
-- Run once: creates all core tables for BEYOND v2.1
...
CREATE TABLE IF NOT EXISTS projects (
  ...
  github_url TEXT,
  preview_url TEXT,
  code_visibility TEXT DEFAULT 'private',
...
-- Events table (webhook ingestion)
...
-- Prime patterns (consciousness) table
